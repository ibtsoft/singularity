...
public class ActionsRepository {
    ...
    public void addActions(final Object object) {
    ...
    public Object executeAction(final ActionExecutionContext context, final String actionName, final Map<String, Object> params) {
    ...
    private static class ActionMethod {
        ...
        ActionMethod(final Object object, final Method method) {
            this.object = object;
            this.method = method;
        }
